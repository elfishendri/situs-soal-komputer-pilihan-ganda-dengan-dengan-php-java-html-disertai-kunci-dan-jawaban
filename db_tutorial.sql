...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Des 2020 pada 13.53
...
CREATE TABLE `tbl_soal` (
  ...
  `soal` text CHARACTER SET utf8mb4 NOT NULL,
  `a` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `b` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `c` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `d` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `kunci` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `gambar` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
  `tanggal` date NOT NULL,
  `aktif` enum('Y','N') CHARACTER SET utf8mb4 NOT NULL
...
(6, 'Multimedia adalah ?', 'Teknologi yg memadukan gambar,video dan suara.', 'teknologi yg memadukan Daftar', 'teknologi yg memadukan Baris dan kolom', 'Teknologi yg memadukan Kelistrikan', 'a', '', '2018-07-02', 'Y'),
(7, 'Menurut Anda, di bawah ini adalah gambar?', 'Avatar', 'Pelangi', 'Singa Laut', 'Bulan', 'a', 'gambar.jpg', '2020-10-04', 'Y');
